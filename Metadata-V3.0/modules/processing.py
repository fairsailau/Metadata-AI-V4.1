...
def process_files():
    ...
    with st.expander("Metadata Template Management", expanded=True):
        ...
        template_name = st.text_input("Template Name", key="save_template_name_input")
            ...
            for retry in range(max_retries):
                try:
                    ...
                    if retry == max_retries - 1:
                        ...
                        status_text.text(f"Retrying {file_name} in {retry_delay} seconds...")
